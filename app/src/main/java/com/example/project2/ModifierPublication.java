...
//    String urlP;
//    DatabaseReference databaseReference, databaseReferencee,archive,user,up;
...
//                                                            // Get Post object and use the values to update the UI
//
//                                                           Producti i=dataSnapshot.getValue(Producti.class);
//                                                            databaseReference.child(i.getIdc()).setValue(pp);
//                                                            pp.setId(i.getIdc());
//                                                            p.setId(i.getIdc());
//
//                                                            archive.child(i.getIdc()).setValue(pp);
//                                                            databaseReferencee.child(i.getIdc()).setValue(p);
//
//
//                                                        }
//
