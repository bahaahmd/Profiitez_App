...
public class ArchiveAdapter extends RecyclerView.Adapter<ArchiveAdapter.ProduitVendeurViewHolder> {
private final RecyclerViewInterface recyclerViewInterface;
        Context context;
        ArrayList<ProductHome> ProductVendeur ;

public ArchiveAdapter(Context context, ArrayList<ProductHome> list,RecyclerViewInterface recyclerViewInterface )
        {
...
@NonNull
@Override
public ArchiveAdapter.ProduitVendeurViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.vendeur_post,parent,false);
        return new ArchiveAdapter.ProduitVendeurViewHolder(view);
        }
